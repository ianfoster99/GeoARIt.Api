...
namespace IO.Swagger.Api
{
    ...
    public class VenuesNearbyApi : IVenuesNearbyApi
    {
        ...
        /// <param name="authorization"></param> 
        /// <returns>List&lt;Venue&gt;</returns>            
        public List<Venue> VenuesNearby (double? lat, double? lng, int? maxToLoad, int? radiusMeters, int? includeDemos, string authorization)
        {
            ...
            if (authorization == null) throw new ApiException(400, "Missing required parameter 'authorization' when calling VenuesNearby");
