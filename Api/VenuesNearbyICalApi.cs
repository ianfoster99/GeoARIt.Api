...
namespace IO.Swagger.Api
{
    ...
    public class VenuesNearbyICalApi : IVenuesNearbyICalApi
    {
        ...
        /// <param name="authorization"></param> 
        /// <returns>List&lt;Venue&gt;</returns>            
        public List<Venue> VenuesICalendar (double? lat, double? lng, int? maxToLoad, int? radiusMeters, string authorization)
        {
            ...
            if (authorization == null) throw new ApiException(400, "Missing required parameter 'authorization' when calling VenuesICalendar");
