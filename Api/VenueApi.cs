...
namespace IO.Swagger.Api
{
    ...
    public class VenueApi : IVenueApi
    {
        ...
        /// <param name="authorization"></param> 
        /// <returns>Venue</returns>            
        public Venue Venue (Guid? guid, string authorization)
        {
            ...
            if (authorization == null) throw new ApiException(400, "Missing required parameter 'authorization' when calling Venue");
