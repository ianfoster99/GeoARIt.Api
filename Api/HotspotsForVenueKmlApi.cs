...
namespace IO.Swagger.Api
{
    ...
    public class HotspotsForVenueKmlApi : IHotspotsForVenueKmlApi
    {
        ...
        /// <param name="authorization"></param> 
        /// <returns>List&lt;Hotspot&gt;</returns>            
        public List<Hotspot> HotspotsForVenueAsKml (Guid? venueGuid, int? maxToLoad, string authorization)
        {
            ...
            if (authorization == null) throw new ApiException(400, "Missing required parameter 'authorization' when calling HotspotsForVenueAsKml");
