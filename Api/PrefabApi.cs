...
namespace IO.Swagger.Api
{
    ...
    public class PrefabApi : IPrefabApi
    {
        ...
        /// <param name="authorization"></param> 
        /// <returns>Prefab</returns>            
        public Prefab Prefab (Guid? guid, string authorization)
        {
            ...
            if (authorization == null) throw new ApiException(400, "Missing required parameter 'authorization' when calling Prefab");
