...
namespace IO.Swagger.Api
{
    ...
    public class HotspotsForVenueApi : IHotspotsForVenueApi
    {
        ...
        /// <param name="authorization"></param> 
        /// <returns>List&lt;Hotspot&gt;</returns>            
        public List<Hotspot> HotspotsForVenue (Guid? venueGuid, int? maxToLoad, string authorization)
        {
            ...
            if (authorization == null) throw new ApiException(400, "Missing required parameter 'authorization' when calling HotspotsForVenue");
